        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Address_HouseNumber = table.Column<string>(type: "nvarchar(10)", maxLength: 10, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BikePhotos", x => x.Id);
                    table.ForeignKey(
                        name: "FK_BikePhotos_Bikes_BikeId",
                        column: x => x.BikeId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Likes", x => new { x.UserId, x.BikeId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    MsgNotification = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    IsPublished = table.Column<bool>(type: "bit", nullable: false),
                    DateOccurred = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false),
                    LikeBikeId = table.Column<int>(type: "int", nullable: true),
                    LikeUserId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.ForeignKey(
                        name: "FK_DomainEvent_Likes_LikeUserId_LikeBikeId",
                        columns: x => new { x.LikeUserId, x.LikeBikeId },
                        principalTable: "Likes",
                        principalColumns: new[] { "UserId", "BikeId" });
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DomainEvent_LikeUserId_LikeBikeId",
                table: "DomainEvent",
                columns: new[] { "LikeUserId", "LikeBikeId" });

            migrationBuilder.CreateIndex(
                name: "IX_Likes_BikeId",
                table: "Likes",
                column: "BikeId");
